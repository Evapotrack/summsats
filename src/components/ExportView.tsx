  ...
  return (
    <div className="p-4 max-w-lg mx-auto">
      <div className="flex items-center gap-2 mb-4">
        <h2 className="text-base font-semibold text-white" style={{ fontFamily: 'Georgia, serif' }}>Export</h2>
        <HelpLink />
      </div>

      <div className="space-y-4">
        <section>
          <h3 className="text-gray-400 text-xs font-semibold uppercase tracking-wider mb-2">What to export</h3>
          <div className="space-y-1">
            ...
            <label className="flex items-center justify-between px-3 py-2 bg-gray-900 rounded-lg cursor-pointer">
        ...
        <section>
          <h3 className="text-gray-400 text-xs font-semibold uppercase tracking-wider mb-2">Format</h3>
          <div className="flex items-center justify-between px-3 py-2 bg-gray-900 rounded-lg">
        ...
        <button
          ...
          disabled={!canExport}
          className="w-full py-2 bg-amber-700 hover:bg-amber-600 text-white rounded-lg text-sm font-semibold transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
        >
